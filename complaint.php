...
if(isset($_POST["submit"]))
{
 ...
 {
  $sql="insert into complaint (NAME,AGE,DIS,CDIS,PROBLEM,CAREA,file) values ('{$_POST["name"]}','{$_POST["age"]}','{$_POST["district"]}','{$_POST["pdistrict"]}','{$_POST["problem"]}','{$_POST["parea"]}','{$target_file}')";
  $db->query($sql);
